...
class SqueezenetExperiment(HoromaExperiment):
    ...
    def _train_embedding(self,
                    ...
                    if use_kmeans:
                        ...
                        if len(output_arr) < 2:
                            ...
                            with warnings.catch_warnings():
                                ...
                                clf = KMeans(n_clusters=self._cluster_obj.n_clusters).fit(output_arr)
        ...
        valid_len, valid_acc = self.eval_model(valid_valid_loader)

        print("Loader len: ", valid_len)
    ...
    def eval_model(self, valid_loader):
        ...
        self._embedding_model.eval()  # Set model to evaluation  mode
        ...
        return(len(valid_loader.dataset), epoch_acc)
